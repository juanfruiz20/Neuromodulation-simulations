# train_lowres_cgan_freeze_tus.py
# =========================================================
# Low-Resolution Global Residual cGAN + Freeze Focus Loss
#
# Objetivo:
#   Mejorar la estructura global del campo sin tocar demasiado
#   la regi�n focal que ya predice bien el UNet base.
#
# Flujo:
#   y_base = UNet_frozen(x)
#   x_low, y_base_low -> G_low -> delta_low
#   delta = upsample(delta_low)
#   y_fake = ReLU(y_base + alpha * delta)
#
# Discriminador:
#   trabaja solo en baja resoluci�n
#
# Loss G:
#   L = lambda_global * L1_global
#     + lambda_brain  * L1_brain
#     + lambda_freeze * L_freeze_focus
#     + lambda_adv    * L_adv_low
# =========================================================
...
# Radio de la ROI focal congelada (en voxeles del volumen original)
FREEZE_RADIUS_VOX = 5
...
def compute_generator_losses(
    ...
    y_gt_low = downsample_to_lowres(y_gt)
...
def main():
    ...
    print("========================================")
    print("Low-Resolution Global Residual cGAN + Freeze")
    print("========================================")
    print("DEVICE:", DEVICE)
    ...
    print("FREEZE_RADIUS_VOX:", FREEZE_RADIUS_VOX)
    print("========================================")
