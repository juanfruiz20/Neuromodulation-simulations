...
#folder_path = r"/data/home/agustin/Documents/oslo/TFG Juanfe/Neuromodulation-simulations/checkpoints_cgan_exp04_300epoch/test_metric_dice"
...
#combined_df.to_csv('master_results_cGANexp4_1_300_nuevooo.csv', index=False)
#import pandas as pd
...
mis_archivos = [
    ...
    r"/data/home/agustin/Documents/oslo/TFG Juanfe/Neuromodulation-simulations/checkpoints_cgan_exp04_300epoch/test_metric_dice/epoch_300_summary.csv"
]
...
nombre_salida = 'master_results_ultimo.csv'
